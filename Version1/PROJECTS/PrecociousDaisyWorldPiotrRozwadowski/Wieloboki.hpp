...
Wielobok(); //Ale jest konstruktor bezparametrowy bo na upartego mo¿e byæ "zerowy"
...
Wielobok& operator = (const Wielobok& Wzorek);
...
static const Wielobok& Surface();
static const Wielobok& Center_plant();
static const Wielobok& Plant();
static const Wielobok& Sun(); 
static const Wielobok& Sun_center();    
