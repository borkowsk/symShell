...
ssh_rgb   get_rgb_from(ssh_color c);        /* Jakie s¹ ustawienia RGB konkretnego kolorku w palecie */
...
void print_rgb(int x,int y,
	...
	ssh_color back,
    const char* format,...); /* Drukuje z mo¿liwoœci¹ ustawienia tuszu poprzez RGB */

/* PUNKTOWANIE  */
void plot(int x,int y, ssh_color c);		/* Wyswietlenie punktu na ekranie */
void plot_rgb(int x,int y,int r,int g,int b);

void fill_flood(int x,int y,ssh_color fill,ssh_color border);/* Wypelnia powodziowo lub algorytmem siania */
...
void line(int x1,int y1,int x2,int y2,ssh_color c);/* Wyswietlenie lini w kolorze c */

void circle_d(int x,int y,int r);		           /* Wyswietlenie okregu w kolorze domyslnym */
void circle(int x,int y,int r,ssh_color c);		   /* Wyswietlenie okregu w kolorze c */

void fill_circle_d(int x,int y,int r);	           /* Wyswietlenie kola w kolorach domyslnych*/
void fill_circle(int x,int y,int r,ssh_color c);   /* Wyswietlenie kola w kolorze c */

void fill_rect_d(int x1,int y1,int x2,int y2);     /* Wyswietla prostokat w kolorach domyslnych*/
void fill_rect(int x1,int y1,int x2,int y2,ssh_color c);/* Wyswietla prostokat w kolorze c */
...
int  get_char(void);    	                        /* Funkcja odczytywania znakow sterowania i zdarzen */
...
#ifdef __cplusplus
//Konwerter ¿eby nie trzeba by³o u¿ywaæ adresów
